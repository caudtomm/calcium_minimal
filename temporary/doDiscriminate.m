function [totFractionCorrectLab,totFractionCorrectLabSH, m] = doDiscriminate(experiment, classifier, dozscore, stims2use, trainblockmode, s)
...
for i_fish = 1:nfish
    ...
    if dozscore; a = nanzscore(a,[],2); end
    a = traceFormat(a,L);
