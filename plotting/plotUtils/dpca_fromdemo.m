function out = dpca_fromdemo(trialNum, firingRates, firingRatesAverage, time, pl)
%
% trialNum: N x S x D
...
accuracy = dpca_classificationAccuracy(firingRatesAverage, firingRates, trialNum, ...
    ...
    'decodingClasses', [], ...
    'simultaneous', ifSimultaneousRecording, ...
    'numRep', 50, ...        % increase to 100
    'filename', 'tmp_classification_accuracy.mat');

if pl; dpca_classificationPlot(accuracy, [], [], [], decodingClasses); end
...
if pl; dpca_classificationPlot(accuracy, [], accuracyShuffle, [], decodingClasses); end
