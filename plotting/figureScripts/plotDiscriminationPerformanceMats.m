        ...
        function [hf, out, groups, odor_sets] = plotDiscriminationPerformanceMats(v, method,focus_stims,do_zscore)  
            arguments
                v ExperimentViewer
                method = 'correlation'
            ...
            for i_g = 1:ngroups
                ...
                for i_o = 1:nodor_sets
                    ...
                    out{n} = v.plotDiscriminationHead(...
                                    'plotType', 'performance_mats', ...
                                    'method',method, ...
