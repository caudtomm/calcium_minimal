classdef ActivityTraces
    ...
    methods
        ...
        function bad_unit_labs = checkTracesMan(obj)
            ...
            remaining_idx = idx_toshow;    % init         
            for i_trial = 1:obj.ntrials
                thistraces = traces(:,remaining_idx,i_trial);
                figure; imagesc(thistraces); title(num2str(i_trial)); xlabel('units')
